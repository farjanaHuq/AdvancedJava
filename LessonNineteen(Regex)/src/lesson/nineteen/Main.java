...
public class Main {
	...
	public static void main(String[] args) {
		System.out.println("Hello Lesson Nineteen");

		String longString = " Farjana Huq CA 92614 PA (412)555-1212 farjanaHuq@hotmail.com 412-555-1234 412 555-1234 ";
		String strangeString = " 1Z aaa **** *** {{{ {{ { ";

		/*
		 * [ ] Insert characters that are valid [^ ] Insert characters that are not
		 * valid \\s Any white space \\S Any non white space {n,m} Whatever proceeds
		...
		/*
		 * \\d Any digits 0-9 \\D Anything not a number {n} Whatever proceeds must occur
		 * n times
		 */
		...
		/*
		 * {n,} Whatever proceeds must occur at least n times + Whatever proceeds must
		 * occur one or more times . ^ * + ? { } [ ] \ | ( ) Characters that must be
		 * escaped or backslashed
		 */
		...
		/*
		 * \\w Any word type character A-Z, a-z, 0-9, _ \\W Any non word character
